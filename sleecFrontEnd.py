...
sample_text = read_model_file("dressingrobot.sleec")
...
KEYWORD   = r"\b(?P<KEYWORD>event|measure|constant|when|then|within|minutes|hours|seconds|unless|otherwise|boolean|numeric|scale|not|and|or|def_start|def_end|rule_end|rule_start|concern_start|concern_end|True|False|def_start|def_end|eventually)\b"
